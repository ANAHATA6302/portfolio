...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './Portfolio-composeApp.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./Portfolio-composeApp.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
